...
# Link tới Teams channel nơi report được post (cho reviewer xem output scheduler).
# Override qua env TEAMS_CHANNEL_URL nếu cần.
TEAMS_CHANNEL_URL = os.getenv(
    "TEAMS_CHANNEL_URL",
    "https://teams.cloud.microsoft/l/team/19%3AYLGZpv2i2iXFR7BDGiujd3LGVcqpy5Jcz9B8hCo7OLw1%40thread.tacv2/conversations"
    "?groupId=b557a8fc-4790-4644-a6a1-5c840aaeaa73&tenantId=7c112a6e-10e2-4e09-afc4-2e37bc60d821",
)
...
<div style="max-width:760px;margin:0 auto">
  ...
  <div style="background:#fff;border-radius:0 0 10px 10px;padding:18px 24px;
    ...
    <div style="margin-top:20px;padding-top:12px;border-top:1px solid #f0f0f0;
      ...
      📍 Xem report trên Teams channel:
      <a href="{TEAMS_CHANNEL_URL}" style="color:#0068ff;font-weight:600;text-decoration:none">
        QE Watchdog — Daily Report</a>
    </div>
    <div style="margin-top:6px;font-size:11px;color:#aaa">Generated by QE Watchdog Agent • {date_str}</div>
  </div>
</div>
</body></html>"""
